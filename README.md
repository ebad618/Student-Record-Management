...
int main() {
    ...
    insertNode(&head, 201, "Lena", 27);
    insertNode(&head, 203, "Aleena", 19);
...
int main() {
    ...
    strcpy(studentList->name, "Laiba");
    studentList->age = 27;

    // Searching a student by name
    char nameToSearch[50] = "Laiba";
...
int main() {
    ...
    insertNode(&head, "Ebad", 22);
    insertNode(&head, "Sherry", 23);
    insertNode(&head, "Jawad", 19);

    printList(head);

    deleteNextNode(head, "Sherry");
